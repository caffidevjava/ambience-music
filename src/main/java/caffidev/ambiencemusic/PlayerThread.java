...
import caffidev.ambiencemusic.thirdparty.javazoom.jl.player.JavaSoundAudioDevice;
import caffidev.ambiencemusic.thirdparty.javazoom.jl.player.advanced.AdvancedPlayer;
...
public class PlayerThread extends Thread {
	...
	static {
		fadeGains = new float[AmbienceMusic.FADE_DURATION];
