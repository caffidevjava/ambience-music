...
@Mod(modid = AmbienceMusic.MOD_ID, name = AmbienceMusic.MOD_NAME, version = AmbienceMusic.VERSION, dependencies = AmbienceMusic.DEPENDENCIES)
public class AmbienceMusic {

    public static final String MOD_ID = "ambience";
    public static final String MOD_NAME = MOD_ID;
    public static final String BUILD = "r1";
    public static final String VERSION = "v1.0.0" + BUILD;
    ...
    //Obfuscated classes, that will be imported from minecraft with help of ObfuscationReflectionHelper
