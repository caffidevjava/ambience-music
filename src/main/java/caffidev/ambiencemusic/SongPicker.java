...
public final class SongPicker {
	...
	public static final Map<Type, String[]> primaryTagMap = new HashMap();
	public static final Map<Type, String[]> secondaryTagMap = new HashMap();
	...
	public static String[] getSongs() {
    	...
    	Map<UUID, BossInfoClient> map = ObfuscationReflectionHelper.getPrivateValue(GuiBossOverlay.class, bossOverlay, AmbienceMusic.OBF_MAP_BOSS_INFOS);
        if(!map.isEmpty()) {
        	try {
